...
2. 词源,
   ...
   **Etymology**
   ...
   Old English stybb "stump of a tree," from Proto-Germanic *stubjaz (source also of Middle Dutch stubbe, Old Norse stubbr), from PIE root *(s)teu- (1) "to push, stick, knock, beat" (see [steep](https://www.etymonline.com/word/steep?ref=etymonline_crossreference) (adj.)). Extended 14c. to other short, thick, protruding things. Meaning "remaining part of something partially consumed" is from 1520s.

   *stub (v.)*

   **mid-15c., "dig up stumps, dig up by the roots," from [stub](https://www.etymonline.com/word/stub?ref=etymonline_crossreference) (n.). The sens of "strike (one's toe) against" something projecting from a surface is first recorded 1848. Meaning "to extinguish a cigarette" is from 1927. Related: Stubbed; stubbing.

3. 释义

   1) 残余部分，残端；（尤指）烟蒂，存根，票根 the short part of something that is left after the main part has been used, especially acigarette after it has beensmoked or one of the smallpieces of paper left in a bookfrom which cheques or ticketshave been torn

   2)不小心把脚趾碰伤  to hurt your toe by hitting it against a hard object byaccident
...
1. 助记
   ...
   dar "house" + sina'ah "art, craft, skill,"
...
3. 释义,
   ...
   1) 武器库；军火库a building where weapons andmilitary equipment are stored
